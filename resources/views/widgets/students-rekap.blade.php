    ...
    <div class="p-6 bg-white rounded-lg shadow ">
        ...
        <div class="overflow-x-auto mt-6 rounded-lg">
            <table class="border-collapse border border-gray-200 w-full text-center"
                ...
                <thead>
                    <tr>
                        <th rowspan="2" class="border p-2 bg-gray-100 sticky left-0" style="width: 160px;">Nama Siswa
                        </th>
                        <th rowspan="2" class="border p-2 bg-gray-100 sticky left-0" style="width: 100px;">Kelas
                        </th>
                    ...
                    @foreach ($students as $student)
                        <tr class="hover:bg-gray-50">
                            <td class="border bg-white sticky left-0" style="width: 160px; height: 30px; padding: 5px;">
                                {{ $student['name'] }}</td>
                            <td class="border bg-white sticky left-0" style="width: 100px; height: 30px; padding: 5px;">
                                {{ $student['grade'] }}</td>
                            @foreach ($months as $short => $full)
